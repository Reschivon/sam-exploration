...
def train(cfg, policy_net, target_net, optimizer, scheduler, batch, transform_func):
    ...
    for timestep in tqdm(range(start_timestep, total_timesteps_with_warm_up),
        ...
        if timestep >= cfg.learning_starts:
            ...
            if use_teacher_net:
                ...
                train_info = train(cfg, policy.policy_net, target_net, optimizer, scheduler, batch, policy.apply_transform)

        train_summary_writer.add_scalar('lr', scheduler.get_last_lr()[0], timestep)
